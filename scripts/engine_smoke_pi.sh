...
ENGINE_MARK="${ENGINE_BUILD_MARK:-sc313-jackPiUGens}"
...
grep -E 'jackPiUGens|jackFork|jackJoin|jackExternal|SC_AUDIO|scsynth connected|listening on OSC|Engine synths|ENGINE_TEST|ERROR|Boolean|syntax|JackTemporary|not understood|POPen|jackd ready|scsynth ready|WARN:' "$LOG" || true
